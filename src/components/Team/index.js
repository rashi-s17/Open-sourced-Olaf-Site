...
const TeamComponent = (props) => {
    ...
    return (
                <TeamCard>
                    ...
                    <SocialIcons>
                        <SocialIconLink href={github_url} target="_blank" aria-label="Github">
                            <FaGithub/>
                        </SocialIconLink>
                        <SocialIconLink href={twitter_url} target="_blank" aria-label="Twitter">
                            <FaTwitter/>
                        </SocialIconLink>
                        <SocialIconLink href={linkedin_url} target="_blank" aria-label="LinkedIn">
                            <FaLinkedin/>
                        </SocialIconLink>
                    </SocialIcons>
                </TeamCard>
    ...
    return (
        <TeamContainer id="members">
            ...
            <TeamWrapper>
                ...
                <TeamComponent url={Member7} name="Bushra Akram" github="codingbug671" twitter="" linkedin="" />
                <TeamComponent url={Member9} name="Deepak Agrawal" github="DebugAgrawal" twitter="debugagrawal" linkedin="your-network-is-your-net-worth" />
                <TeamComponent url={Member10} name="Marco Chan" github="m2chan" twitter="" linkedin="marco-chan" />
                <TeamComponent url={Member11} name="Sena Yevenyo" github="iamyevesky" twitter="iamyevesky" linkedin="sena-yevenyo" />
